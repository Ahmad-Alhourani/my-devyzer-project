...
class ContactController extends Controller
{
    ...
    public function create()
    {
        ...
        $selectedCustomer = Customer::first() ? Customer::first()->_id : 0;

        $status = Status::all();
        $selectedStatus = Status::first() ? Status::first()->_id : 0;
    ...
    public function edit(Contact $contact)
    {
        ...
        return view(
            ...
            compact("customers", "selectedCustomer", "status", "selectedStatus")
